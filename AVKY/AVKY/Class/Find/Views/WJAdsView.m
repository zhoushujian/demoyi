...
- (instancetype)initWithFrame:(CGRect)frame{
    self = [super initWithFrame:CGRectMake(frame.origin.x, frame.size.height-100, frame.size.width, frame.size.height)];
    if (self) {
        [self buildUI];
    }
    return self;
             ...
             usingSpringWithDamping:0.65f
              initialSpringVelocity:0.5
                         ...
                         animations:^{
                             ...
                             containRect.origin.y = (weakSelf.frame.size.height - weakSelf.mainContainView.frame.size.height)/2+50;
