...
//每个格子的高度
#define GridHeight ((ScreenWidth-(PaddingX * (PerRowGridCount+1) )) /PerRowGridCount)
...
//格子的图片
@property(nonatomic, strong)UIImage *gridImageString;
...
- (id)initWithFrame:(CGRect)frame
   ...
   highlightedImage:(UIImage *)highlightedImage
      ...
      withIconImage:(UIImage *)iconImage;
