...
//    _counterButton setTitleColor: forState:<#(UIControlState)#>
    ...
    self.navigationController.navigationBar.backgroundColor = globalColor;
    
    self.navigationController.navigationBar.tintColor = globalColor;
    
    self.navigationController.toolbar.barTintColor = globalColor;
