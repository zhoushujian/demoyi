...
- (void)didFinishedSelectAssets:(NSNotification *)notification {
    ...
    [self requestImages:_selectedAssets completed:^(NSMutableArray<UIImage *> *images) {
        [self.pickerDelegate imagePickerController:self didFinishSelectedImages:images selectedAssets:_selectedAssets];
    }];
}
...
- (void)requestImages:(NSMutableArray <PHAsset *> *)selectedAssets completed:(void (^)(NSMutableArray <UIImage *> *images))completed {
